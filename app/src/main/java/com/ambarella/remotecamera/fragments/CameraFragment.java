...
public class CameraFragment extends Fragment
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        imageView = (Button) view.findViewById(R.id.imageViewStartVF);
        imageView.setOnClickListener(this);

        imageView = (Button) view.findViewById(R.id.imageViewStopVF);
        imageView.setOnClickListener(this);
        ...
        imageView = (Button) view.findViewById(R.id.imageViewStartRecord);
        imageView.setOnClickListener(this);

        imageView = (Button) view.findViewById(R.id.imageViewStopRecord);
        imageView.setOnClickListener(this);

        imageView = (Button) view.findViewById(R.id.imageViewForceSplit);
        imageView.setOnClickListener(this);

        imageView = (Button) view.findViewById(R.id.imageViewStartPhoto);
        imageView.setOnClickListener(this);

        imageView = (Button) view.findViewById(R.id.imageViewStopPhoto);
        imageView.setOnClickListener(this);

        imageView = (Button) view.findViewById(R.id.imageViewZoomInfo);
        imageView.setOnClickListener(this);
