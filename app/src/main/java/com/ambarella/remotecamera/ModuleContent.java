...
public class ModuleContent {
    ...
    public static final int MODULE_POSE_NONE = 5;
    public static final int MODULE_POSE_WIFI_SETTINGS = 6;
    ...
    static {
        ...
        addItem(new ModuleItem(MODULE_POSE_WIFI_SETTINGS, "wifiSettings"));
